...
export default function DashboardPage() {
  ...
  // persist is only queried inside the effect: it is undefined during
  // server prerender, which used to crash the production build.
  ...
  return (
    <main className="container" style={{ paddingTop: '100px', paddingBottom: '80px' }}>
      <div style={{ marginBottom: '40px' }}>
        <h1 className="text-gradient" style={{ fontSize: '36px', fontWeight: '700', marginBottom: '8px' }}>
          Account Dashboard
        </h1>
      ...
      >
        ...
        >
          <div style={{ flex: 1, minWidth: '300px' }}>
            ...
            <div style={{ color: 'var(--color-text-secondary)', fontSize: '15px', marginBottom: '24px' }}>
              {MOCK_RENTAL.storage} • {MOCK_RENTAL.color} • Started{' '}
              {MOCK_RENTAL.startDate.toLocaleDateString('en-IN', { month: 'short', year: 'numeric' })}
            </div>
            ...
            <div style={{ textAlign: 'center', maxWidth: '200px' }}>
              {monthsUntilUpgrade <= 3 ? (
                <button
                  ...
                  onClick={() =>
                    toast('Upgrade claims open at the end of your cycle. Our team will reach out!', { icon: '🚀' })
                  }
                >
                  Claim Upgrade
                </button>
                ...
                <span style={{ fontSize: '13px', color: 'var(--color-text-secondary)' }}>
                  Eligible for free upgrade after {monthsUntilUpgrade} payments.
                </span>
              )}
            </div>
          </div>
        ...
        >
          <div>
            ...
            <div
              style={{ fontSize: '32px', fontWeight: '700', color: 'var(--color-cosmic-orange)', marginBottom: '4px' }}
            >
              ₹{MOCK_RENTAL.monthlyRent.toLocaleString('en-IN')}
            </div>
          ...
          <button
            ...
            onClick={() =>
              toast('Rent payment simulation — autopay is already active on this account.', { icon: '💳' })
            }
          >
            Pay Now
          </button>
        ...
        <div className="glass" style={{ padding: '24px', borderRadius: 'var(--radius-lg)' }}>
          ...
          <p
            style={{ fontSize: '14px', color: 'var(--color-text-secondary)', marginBottom: '24px', lineHeight: '1.5' }}
          >
          ...
          >
            <span
              style={{ fontSize: '20px', fontWeight: '700', letterSpacing: '2px', color: 'var(--color-cosmic-orange)' }}
            >
              UPGRADE1000
            </span>
          </div>
